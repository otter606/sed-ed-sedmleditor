...
public class ConnectionReconnectCommand extends Command {
	...
	private GElement newSource;
	/** The new target endpoint. */
	private GElement newTarget;
	/** The original source endpoint. */
	private final GElement oldSource;
	/** The original target endpoint. */
	private final GElement oldTarget;
	...
	private boolean checkSourceReconnection() {
		...
		for (Iterator iter = newSource.getSrcConnections().iterator(); iter
				.hasNext();) {
	 ...
	 */
	public void setNewSource(GElement connectionSource) {
	 ...
	 */
	public void setNewTarget(GElement connectionTarget) {
