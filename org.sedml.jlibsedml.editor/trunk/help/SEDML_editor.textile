...
This document describes how to use the SED-ML graphical  editor plugin for SBSI, for the creation, viewing and editing of SED-ML files.  This documentation is valid for version 0.9.4.

h2. New in this version

Version 0.9 contains several new features and bug fixes, which are described more completely in the ensuing documentation:
