 ...
 */
 class NamespaceContextHelper implements NamespaceContext {
	 ...
	 * </p>
	 */
	public NamespaceContextHelper( Map<String, String> initialNamespaces) {
	 ...
	 *            An XPath expression
	 */
	NamespaceContextHelper(org.jdom.Document doc) {
	...
	void process (XPathTarget target) {
	...
	boolean isAllXPathPrefixesMapped(XPathTarget target){
		Set<String> xpathPrefixes = target.getXPathPrefixes();
		for (String prefix : xpathPrefixes) {
